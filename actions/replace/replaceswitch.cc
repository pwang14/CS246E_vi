...
matchInfo ReplaceSwitch::matches(const vector<int> &input) {
...
bool ReplaceSwitch::partialMatches(const vector<int> &input) { return false; }

void ReplaceSwitch::action(VmState *vmstate) {
